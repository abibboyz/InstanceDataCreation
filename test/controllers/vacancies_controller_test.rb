...
class VacanciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacancy" do
    assert_difference("Vacancy.count") do
      post vacancies_url, params: { vacancy: { site_id: @vacancy.site_id, title: @vacancy.title } }
    end
  ...
  test "should update vacancy" do
    patch vacancy_url(@vacancy), params: { vacancy: { site_id: @vacancy.site_id, title: @vacancy.title } }
